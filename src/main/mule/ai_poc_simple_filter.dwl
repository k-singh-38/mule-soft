...
public class AI_PoC_Simple_Filter {
    ...
    public String processMessage(String message_string) {
        ...
        try {
            ...
            List<Map<String, String>> msaSegments = (List<Map<String, String>>) input_map.get("MSA");
            if (msaSegments != null && !msaSegments.isEmpty()) {
                log("Multiple MSA segments found.");
                String msa_text_message = msaSegments.get(0).get("MSA-3-text_message");
